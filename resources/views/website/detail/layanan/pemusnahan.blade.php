...
@section('content')
    @php
        ...
        $title = $layanan->nama ?? 'Pemusnahan Dokumen & Produk Expired';
    @endphp
                ...
                <div class="row gy-4 mb-5">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="contact-info-card text-start mb-4">
                            ...
                            <h4 class="fw-bold mb-2">Jasa Pemusnahan Resmi</h4>
                            <p class="text-muted mb-4">Layanan pemusnahan dokumen rahasia, arsip kantor, dan produk kadaluarsa dengan berita acara resmi.</p>
                            <a href="https://wa.me/6281511119337?text=Assalamu'alaikum%2C%20saya%20ingin%20konsultasi%20pemusnahan%20dokumen%2Fproduk" target="_blank" class="btn btn-success w-100 rounded-pill py-2">
                                <i class="bi bi-whatsapp me-1"></i> Konsultasi Pemusnahan
                            </a>
                        </div>
                    </div>
