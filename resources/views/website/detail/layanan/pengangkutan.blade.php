...
@section('content')
    @php
        ...
        $title = $layanan->nama ?? 'Layanan Pengangkutan Sampah';
    @endphp
                ...
                <div class="row gy-4 mb-5">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="contact-info-card text-start mb-4">
                            ...
                            <h4 class="fw-bold mb-2">Order Layanan Pengangkutan</h4>
                            <p class="text-muted mb-4">Jadwalkan pengangkutan sampah untuk perumahan, industri, atau instansi Anda.</p>
                            <a href="https://wa.me/6281511119337?text=Assalamu'alaikum%2C%20saya%20ingin%20memesan%20jadwal%20layanan%20pengangkutan%20sampah" target="_blank" class="btn btn-success w-100 rounded-pill py-2">
