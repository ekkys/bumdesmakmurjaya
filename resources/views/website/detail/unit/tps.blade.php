...
@section('content')
    @php
        $unit = $units->first();
        $title = $unit->nama ?? 'Detail Unit Usaha';
    @endphp
                ...
                <div class="row gy-4 mb-5">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="contact-info-card text-start mb-4">
                            ...
                            <h4 class="fw-bold mb-2">Konsultasi Layanan</h4>
                            <p class="text-muted mb-4">Butuh informasi lebih lanjut seputar unit usaha ini?</p>
                            <a href="https://wa.me/6281511119337?text=Assalamu'alaikum%2C%20saya%20tertarik%20dengan%20informasi%20{{ urlencode($item->nama) }}" target="_blank" class="btn btn-success w-100 rounded-pill py-2">
