    ...
    <div class="container card mt-5">
        ...
        <form action="{{ route('galeri.update', $galeri->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img src="{{ asset('storage/' . $galeri->gambar) }}" alt="Current Image" width="100">
            </div>
            <div class="mb-3">
                <label for="tanggal" class="form-label">Tanggal</label>
                <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ $galeri->tanggal }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="status" name="status">
                    ...
                    <option value="tidak" {{ $galeri->status == 'tidak' ? 'selected' : '' }}>tidak tampil</option>
                </select>
            </div>
